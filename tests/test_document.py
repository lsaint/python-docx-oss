...
class DescribeDocument:
    ...
    def it_can_add_a_float_picture(
        self,
        document: Document,
        add_paragraph_: Mock,
        run_: Mock,
    ...
    def it_provides_access_to_its_styles(self, styles_prop_, styles_):
    ...
    @pytest.fixture
    def float_picture_(self, request: FixtureRequest):
    ...
    def styles_prop_(self, request: FixtureRequest):
        return property_mock(request, Document, "styles")
