...
class Document(ElementProxy):
    ...
    def add_paragraph(self, text: str = "", style: str | ParagraphStyle | None = None) -> Paragraph:
        r"""Return paragraph newly added to the end of the document.
    ...
    def add_float_picture(
        ...
        """Add float picture at fixed position `pos_x` and `pos_y` to the top-left
        point of page.
        """
        run = self.add_paragraph().add_run()
    ...
    def custom_properties(self) -> CustomProperties:
        """A |CustomProperties| object providing custom properties of document."""
