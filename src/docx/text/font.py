...
class Font(ElementProxy):
    ...
    def name(self) -> str | None:
        ...
        Returns the value of `ascii` font. To access other font settings, use `eastAsia`
        or `hAnsi` properties.
        """
        rPr = self._element.rPr
        if rPr is None:
    ...
    @name.setter
    def name(self, value: dict[str, str | None] | str | None) -> None:
        rPr = self._element.get_or_add_rPr()
    ...
    @eastAsia.setter
    def eastAsia(self, value: str | None) -> None:
        rPr = self._element.get_or_add_rPr()
        rPr.rFonts_eastAsia = value

    @property
    def hAnsi(self) -> str | None:
        """The high ANSI typeface name for this |Font|."""
        rPr = self._element.rPr
        if rPr is None:
            return None
    ...
    @hAnsi.setter
    def hAnsi(self, value: str | None) -> None:
        rPr = self._element.get_or_add_rPr()
        rPr.rFonts_hAnsi = value
